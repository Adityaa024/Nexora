        ...
        description={
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3">
              <div className="bg-emerald-50 border border-emerald-100 p-4 rounded-xl text-sm shadow-sm relative overflow-hidden">
              ...
              <div className="bg-blue-50 border border-blue-100 p-4 rounded-xl text-sm shadow-sm relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-400/10 to-transparent pointer-events-none"></div>
                <div className="relative z-10">
                  <p className="font-bold text-blue-800 mb-2 uppercase tracking-wider text-[10px]">Demo Patient Access</p>
                  <div className="flex flex-col gap-1 mb-3">
                    <p className="text-blue-700/80 text-xs flex justify-between gap-4">Email: <span className="font-semibold text-blue-900">patient@patient.com</span></p>
                    <p className="text-blue-700/80 text-xs flex justify-between gap-4">Password: <span className="font-semibold text-blue-900">patient</span></p>
                  </div>
                  <button 
                    type="button"
                    onClick={() => {
                      setEmail('patient@patient.com');
                      setPassword('patient');
                      toast.success('Patient credentials loaded!');
                    }}
                    className="w-full flex items-center justify-center gap-2 bg-blue-600 text-white px-4 py-2.5 rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-blue-700 transition-all shadow-md active:scale-95"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-blue-200"><polygon points="20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                    Load Patient
                  </button>
                </div>
              </div>
